...
@RestController
@CrossOrigin
@RibbonClient (name="custribbon") //ribbon client with name custribbon
public class CustomerController {
	...
	//	List<Long> friends=new RestTemplate().getForObject(friendUri+phoneNo+"/friends", List.class);
		//using the below method for the load balance ribbon method
		List<Long> friends=template.getForObject("http://custribbon/customers/"
